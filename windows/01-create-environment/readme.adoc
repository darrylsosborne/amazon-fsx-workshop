...
It will take approximately 2 hours to complete this workshop and you will be charged approximately *$1.625* to run this environment for 2 hours (based on US East - N. Virginia prices). Be sure you follow the steps in the link:../02-create-file-system-from-backup/[*Delete Workshop Environment*] section so you don't continue to incur charges after completing the workshop.
