...
* Did your email address receive an alarm notification?
. From the remote desktop session window of the *Windows Server 0* instance, delete all the files you created during the previous workshop section *Test performance*. *_Wait_* a few minutes.
...
image::06-monitor-performance.png[link=../05-monitor-performance/, align="left",width=420]
