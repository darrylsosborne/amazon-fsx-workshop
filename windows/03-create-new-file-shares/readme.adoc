...
. From the link:https://console.aws.amazon.com/fsx/[Amazon FSx] console, *_select_* the link to the *MAZ* file system and *_select_* the *Network & security* tab. *_select_* the image::copy-to-clipboard.png[align="left"] shortcut to *_copy_* the *DNS Name* of the file system to the clipboard.
