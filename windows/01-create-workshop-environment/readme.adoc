...
[TIP] It will take approximately 45 minutes for CloudFormation to automatically create your workshop environment, after completing the *Step-by-step Guide* below.
