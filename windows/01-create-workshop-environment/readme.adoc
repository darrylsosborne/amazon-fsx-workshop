...
+
TIP: *_Context-click (right-click)_* the *Deploy to AWS* button and open the page in a new tab to keep both the github workshop and AWS Console available at the same time.
+
