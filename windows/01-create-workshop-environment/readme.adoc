...
[NOTE]
====
Amazon FSx is currently available in 6 regions. File system creation is currently not supported in the following Availability Zones:
+
...
| use1-az3
| Open link:https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#subnets:[us-east-1 VPC] for AZ mapping.

| *Sydney* (ap-southeast-2)
| apse2-az3
| Open link:https://ap-southeast-2.console.aws.amazon.com/vpc/home?region=ap-southeast-2#subnets:[ap-southeast-2 VPC] for AZ mapping.
|===
====
+
|===
