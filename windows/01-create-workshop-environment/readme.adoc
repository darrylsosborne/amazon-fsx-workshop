...
+
NOTE: Amazon FSx is currently available in 6 regions. If launching in Sydney (ap-southeast-2), file system creation is currently not supported for Availability Zone ID *apse2-az3*.
