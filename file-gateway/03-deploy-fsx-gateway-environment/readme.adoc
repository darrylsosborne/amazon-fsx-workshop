...
| *DNS Ip Addresses*
a| Copy in the two DNS Ip addresses of the AWS-managed Active Directory created in Phase 1 - Amazon FSx for Windows File Server environment. This can be found from the link:https://console.aws.amazon.com/directoryservicev2/[AWS Directory Service] console for the directory created in Phase 1 - Amazon FSx for Windows File Server environment deployed in Region 1.
