...
This section will test the write performance of the FSx File Gateway and compare it to the write performance of the FSx for Windows File Server when access over a Wide Area Network (WAN).
...
image::tear-down-workshop.png[link=../08-tear-down-workshop/, align="left",width=420]
