...
This workshop is for re:invent 2019 - STG326 - Deploy fully managed FSx for Windows File Server instances in minutes.
...
NOTE: It will take approximately 2 hours to complete and you will run it using an AWS account that we provide at the workshop.
